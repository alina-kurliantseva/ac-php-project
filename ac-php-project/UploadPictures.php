    ...
    if (isset($btnUpload)) {
        for ($j=0; $j < count($_FILES['txtUpload']['tmp_name']); $j++) {
            ...
            if ($_FILES['txtUpload[]']['error'][$j] == 0) {
                $filePath = $photo->save_uploaded_file(ORIGINAL_PICTURES_DIR, $j);
...
<div class="container text-center">
    <h2 class="mt-5">Upload Pictures</h2><br />
    ...
    <p class="mb-5">When uploading multiple pictures the title and description fields will be applied to all pictures.</p>
